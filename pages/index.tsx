...
const Home: NextPage = ({countries}:any) => {
  ...
  return (
    ...
    <div className={!dark?styles.search_box:styles1.search_box_black}>
    ...
    <main className={!dark?styles.main:styles1.main_black}>
...

    {
      ...
      .filter((country:any)=>country.name.common.toLowerCase().includes(search.toLowerCase())).map((country:any)=>(
        ...
        <Link href={`/country/${country.name.common.split(" ")[0]}`}  key={country.name.common}>
        <div className={!dark?styles.countryItem:styles1.countryItem}>

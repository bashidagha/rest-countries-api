...
const country  = ({country}:any) => {
    ...
    return(
      ...
      <div>
      <Link href="/"><a className={styles.back_button} style={{backgroundColor:"white"}}> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
